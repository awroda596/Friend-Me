...
class ProfileSetting extends State<ProfileSettingRoute> {
  ...
  final aboutTextStyle = const TextStyle( // defines text style
    color: Colors.black,
    fontSize: 12
  );
  ...
  save(){ // Does nothing right now placeholder
                          ...
                          Container(
                            ...
                            child: Column(
                                ...
                                children: <Widget>[
                                  IconButton(
                                    onPressed: settings, 
                                    icon: const Icon(Icons.add_a_photo, color: Colors.white)) // placeholder
                                ]
                            ) 
                             ),
                          IconButton(onPressed: settings, icon: const Icon(Icons.edit, color: Colors.white)) // placeholder
                        ]
                    ),
                  ) 
                ),
