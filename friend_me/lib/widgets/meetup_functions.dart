...
List<MeetUp> ListMeetUpsOffline(){
  ...
  List<MeetUp> MeetUps =[];
  MeetUps.add(MeetUp(id: 1, friend_user: "Shaddam", status: "confirmed", start_time: DateTime.parse("2024-05-07T08+00:00"), end_time:DateTime.parse("2024-05-07T14+00:00") ));
  MeetUps.add(MeetUp(id: 2, friend_user: "Rauban", status: "confirmed", start_time: DateTime.parse("2024-05-08T10+00:00"), end_time:DateTime.parse("2024-05-08T12+00:00") ));
  MeetUps.add(MeetUp(id: 3, friend_user: "Vladimir", status: "confirmed", start_time: DateTime.parse("2024-05-08T11+00:00"), end_time:DateTime.parse("2024-05-08T17+00:00") ));
  MeetUps.add(MeetUp(id: 4, friend_user: "Feyd", status: "confirmed", start_time: DateTime.parse("2024-06-09T05+00:00"), end_time:DateTime.parse("2024-06-08T12+00:00") ));
  MeetUps.add(MeetUp(id: 5, friend_user: "Chani", status: "confirmed", start_time: DateTime.parse("2024-07-09T14+00:00"), end_time:DateTime.parse("2024-07-08T22+00:00") ));
  MeetUps.add(MeetUp(id: 6, friend_user: "Jessica", status: "confirmed", start_time: DateTime.parse("2024-08-10T10+00:00"), end_time:DateTime.parse("2024-08-08T12+00:00") ));
  MeetUps.add(MeetUp(id: 7, friend_user: "Stilgar", status: "confirmed", start_time: DateTime.parse("2024-09-12T10+00:00"), end_time:DateTime.parse("2024-09-08T12+00:00") ));
  MeetUps.add(MeetUp(id: 8, friend_user: "Leto", status: "confirmed", start_time: DateTime.parse("2024-09-15T10+00:00"), end_time:DateTime.parse("2024-09-08T12+00:00") ));
  MeetUps.add(MeetUp(id: 9, friend_user: "Duncan", status: "confirmed", start_time: DateTime.parse("2024-11-20T11+00:00"), end_time:DateTime.parse("2024-11-20T20+00:00") ));
  MeetUps.add(MeetUp(id: 10, friend_user: "Muad-Dib", status: "confirmed", start_time: DateTime.parse("2024-11-08T10+00:00"), end_time:DateTime.parse("2024-11-08T12+00:00") ));
  return MeetUps;
}
